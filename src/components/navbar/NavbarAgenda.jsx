// src/components/navbar/NavbarAgenda.jsx

/**
 * Autor: Manuel Mediavilla Hidalgo
 * Nombre del archivo: NavbarAgenda.jsx
 * Descripción: Este componente muestra la barra de navegación para la agenda de contactos, con iconos de redes sociales y un título centrado.
 */
...
/**
 * Componente para la barra de navegación de la agenda de contactos.
 *
 ...
 */
export default function NavbarAgenda({ currentUser }) {
  ...
  return (
    <div className="flex items-center justify-between p-5 bg-green-600 text-white shadow-md fixed w-full top-0 left-0 z-50">
      <div className="text-2xl font-bold absolute left-1/2 transform -translate-x-1/2">Contactos</div>
      <div className="flex items-center gap-5 ml-auto">
        <FaInstagram
          className="text-white cursor-pointer text-2xl hover:text-yellow-400"
