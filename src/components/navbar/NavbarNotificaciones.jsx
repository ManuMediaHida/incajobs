// src/components/navbar/NavbarNotificaciones.jsx

/**
 * Autor: Manuel Mediavilla Hidalgo
 * Nombre del archivo: NavbarNotificaciones.jsx
 * Descripción: Este componente muestra la barra de navegación para la sección de notificaciones, con iconos de redes sociales y un título centrado.
 */
...
/**
 * Componente para la barra de navegación de la sección de notificaciones.
 *
 ...
 */
export default function NavbarNotificaciones({ currentUser }) {
  ...
  return (
    <div className="flex items-center justify-between p-5 bg-green-600 text-white shadow-md fixed w-full top-0 left-0 z-50">
      <div className="text-2xl font-bold absolute left-1/2 transform -translate-x-1/2">Notificaciones</div>
